<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!-- Authentication -->
                        <form method="POST" action="{{ route('wallet.logout') }}">
                            @csrf
                            <x-dropdown-link :href="route('wallet.logout')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('wallet.dashboard')" :active="request()->routeIs('wallet.dashboard')">
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">{{ Authy::user()->email }}</div>
            </div>
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('wallet.logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('wallet.logout')"
                                           onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
